            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent-555">
                    ...
                    <ul class="navbar-nav ml-auto nav-flex-icons">
                        ...
                        @guest
                            <li class="nav-item">
                                <a type="button" class="btn btn-me btn-outline-warning btn-rounded waves-effect" href="{{ route('login') }}">Login</a>
                            </li>
                            @if (Route::has('register'))
                                <li class="nav-item">
                                    <a type="button" class="btn btn-warning btn-rounded btn-me" href="{{ route('register') }}">Register</a>
                                </li>
                            @endif
                        @else
